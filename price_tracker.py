"""
Lidl Price Tracker - Bright Data Web Scraper API
----------------------------------------------------
Track prices, availability, and product data from Lidl.

Docs  : https://docs.brightdata.jp/scraping-automation/web-scraper-api/overview
Info  : https://brightdata.jp/products/insights/price-tracker/lidl
"""
...
# Set your Web Scraper ID after building your Lidl scraper:
# https://brightdata.jp/products/web-scraper/lidl
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Lidl scraper at: https://brightdata.jp/products/web-scraper/lidl\n"
...
def track_prices(urls: list[str], **kwargs) -> list[dict]:
    """
    Collect price data for a list of Lidl product URLs.
...
def discover_by_keyword(keyword: str, limit: int = 50, **kwargs) -> list[dict]:
    """
    Discover Lidl products by keyword search.
...
def discover_by_category(category_url: str, limit: int = 100, **kwargs) -> list[dict]:
    """
    Discover all products from a Lidl category page.

    Example:
        results = discover_by_category("https://lidl.com/s?k=headphones", limit=200)
    """
...
if __name__ == "__main__":
    ...
    sample_urls = [
        "https://www.lidl.com/products/sample-product",
        # Add more Lidl product URLs here
    ]
    results = track_prices(sample_urls)

    output_file = "lidl_prices.json"
    ...
    # cat_results = discover_by_category("https://lidl.com/category/sample", limit=50)
